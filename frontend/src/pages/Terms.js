...
const Terms = () => {
  return (
    <div className="terms container py-5">
      <h1 className="status__h1">Terms & Conditions</h1>
      <p>Welcome to Opera Online Application!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of Opera International's Website, located at operaonlineapplication.in.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Opera Online Application if you do
      ...
      <h5>Cookies</h5>
      <p>
        We employ the use of cookies. By accessing Opera Online Application, you
        agreed to use cookies in agreement with the Opera International's
        Privacy Policy.
      </p>{" "}
      <p>
      ...
      <h5>License</h5>{" "}
      <p>
        Unless otherwise stated, Opera International and/or its licensors own
        the intellectual property rights for all material on Opera Online
        Application. All intellectual property rights are reserved. You may
        access this from Opera Online Application for your own personal use
        subjected to restrictions set in these terms and conditions.
      </p>
      <h5>You must not:</h5>
      <p>
        Republish material from Opera Online Application <br />
        Sell, rent or sub-license material from Opera Online Application <br />
        Reproduce, duplicate or copy material from Opera Online Application{" "}
        <br />
        Redistribute content from Opera Online Application <br />
        This Agreement shall begin on the date hereof.{" "}
      </p>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. Opera
        International does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Opera International,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Opera
        International shall not be liable for the Comments or for any liability,
      ...
      <p>
        Opera International reserves the right to monitor all Comments and to
      ...
      <p>
        ...
        or present commercial activities or unlawful activity. <br />
        You hereby grant Opera International a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Opera International; and (d)
      ...
      <p>
        ...
        e-mail to Opera International. Please include your name, your
      ...
      <p>
        ...
        being linked to, or By use of any other description of our Website being
        linked to that makes sense within the context and format of content on
        the linking party’s site. No use of Opera International's logo or other
      ...
      <p>
        ...
        is not permitted under applicable law, or exclude any of our or your
